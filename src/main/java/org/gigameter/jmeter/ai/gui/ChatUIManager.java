...
public class ChatUIManager {
    ...
    private JComboBox<ModelInfo> createModelSelector(ClaudeService claudeService, Consumer<ModelInfo> modelSelectionAction) {
        ...
        selector.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected,
                ...
                if (value == null) {
                    return super.getListCellRendererComponent(list, "Р—Р°РіСЂСѓР·РєР° РјРѕРґРµР»РµР№...", index, isSelected,
                            cellHasFocus);
                }
    ...
    private JPanel createModelPanel(JComboBox<ModelInfo> modelSelector) {
        ...
        JLabel modelLabel = new JLabel("РњРѕРґРµР»СЊ: ");
    ...
    private JButton createSendButton(Runnable sendMessageAction) {
        JButton button = new JButton("РћС‚РїСЂР°РІРёС‚СЊ");
    ...
    public void removeLoadingIndicator() {
        ...
        try {
            ...
            int index = text.lastIndexOf("GigaMeter РґСѓРјР°РµС‚...");
            
            log.info("Loading indicator found at index: {}", index);
            
            if (index != -1) {
                // Remove the loading indicator
                doc.remove(index, "GigaMeter РґСѓРјР°РµС‚...".length());
