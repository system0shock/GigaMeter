...
public class ConversationManager {
    ...
    public void displayWelcomeMessage() {
        ...
        String welcomeMessage = "# Добро пожаловать в GigaMeter\n\n" +
                "Я помогу с вашим планом тестирования JMeter: отвечу на вопросы и подскажу, как улучшить сценарии.\n\n" +
                "**Специальные команды:**\n" +
                "- `@this` — информация о выбранном элементе\n" +
                "- `@optimize` — рекомендации по оптимизации\n" +
                "- `@code [команда]` — улучшение выделенного кода в JSR223\n\n" +
                "Чем помочь?";
    ...
    private void addLoadingIndicator() {
        ...
        try {
            messageProcessor.appendMessage(chatArea.getStyledDocument(), "GigaMeter думает...", new Color(128, 128, 128),
                    false);
