...
public class ElementSuggestionManager {
    ...
    public JButton createElementButton(String displayName, String normalizedType, String additionalInfo) {
        ...
        addButton.addActionListener(e -> {
            try {
                ...
                boolean success = org.gigameter.jmeter.ai.utils.JMeterElementManager.addElement(finalNormalizedType, 
                ...
                if (success) {
                    log.info("Successfully added {} to the test plan", 
                            org.gigameter.jmeter.ai.utils.JMeterElementManager.getDefaultNameForElement(finalNormalizedType));
                } else {
    ...
    private String formatElementType(String normalizedType) {
        ...
        try {
            return org.gigameter.jmeter.ai.utils.JMeterElementManager.getDefaultNameForElement(normalizedType);
        } catch (Exception e) {
