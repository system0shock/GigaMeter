...
import org.gigameter.jmeter.ai.service.CodeRefactorer;
...
public class JSR223ContextMenu {
    ...
    private static void addContextMenu(RSyntaxTextArea textArea, AiService aiService) {
        ...
        JMenuItem selectAllItem = new JMenuItem("Выделить всё");
        ...
        JMenuItem aiHelpItem = new JMenuItem("Рефакторинг кода");
            ...
            if (code != null && !code.trim().isEmpty()) {
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            textArea,
                            "Ошибка форматирования: " + ex.getMessage(),
        ...
        JMenuItem functionsDialogItem = new JMenuItem("Диалог функций");
