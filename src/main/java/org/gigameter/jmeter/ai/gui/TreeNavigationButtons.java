...
public class TreeNavigationButtons {
    ...
    public TreeNavigationButtons() {
        try {
            // Load PNG icons
            ImageIcon upIcon = new ImageIcon(getClass().getResource("/org/gigameter/jmeter/ai/icons/up.png"));
            ImageIcon downIcon = new ImageIcon(getClass().getResource("/org/gigameter/jmeter/ai/icons/down.png"));
